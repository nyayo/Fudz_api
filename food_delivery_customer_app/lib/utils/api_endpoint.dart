...
class ApiEndpoint {
  ...
  static String getCategoryDetail(int id) =>
      '$baseUrl/restaurants/categories/$id/';
  static String getRestaurantDetail(int id) =>
      '$baseUrl/restaurants/restaurants/$id/';
  static String getRestaurantCategories(int restaurantId) =>
      '$baseUrl/restaurants/restaurants/$restaurantId/categories/';
  static String getCategoryItems(int restaurantId, int categoryId) =>
      '$baseUrl/restaurants/restaurants/$restaurantId/categories/$categoryId/items/';
  static String getMenuItemDetail(
    int restaurantId,
    int categoryId,
    int itemId,
  ) =>
      '$baseUrl/restaurants/restaurants/$restaurantId/categories/$categoryId/items/$itemId/';

  // Menu Items endpoints
  static const String getAllMenuItems =
      '$baseUrl/restaurants/menu-items/'; // All menu items
  static String getMenuItemDetailById(int itemId) =>
      '$baseUrl/restaurants/menu-items/$itemId/';

  // Cart endpoints
  static const String createCart = '$baseUrl/orders/carts/';
  static String getCart(String cartId) => '$baseUrl/orders/carts/$cartId/';
  static String getCartItems(String cartId) =>
      '$baseUrl/orders/carts/$cartId/items/';
  static String getCartItem(String cartId, int itemId) =>
      '$baseUrl/orders/carts/$cartId/items/$itemId/';
  ...
  static String getOrderDetail(int orderId) =>
      '$baseUrl/orders/orders/$orderId/';
  static String acceptOrder(int orderId) =>
      '$baseUrl/orders/orders/$orderId/accept/';

  // Wishlist endpoints
  static const String getWishlist = '$baseUrl/wishlists/';
  static const String addToWishlist = '$baseUrl/wishlists/add/';
  static String removeFromWishlist(int menuItemId) =>
      '$baseUrl/wishlists/remove/$menuItemId/';

  // Review endpoints
  static const String reviews = '$baseUrl/reviews/';
  static String getRestaurantReviews(int restaurantId) =>
      '$baseUrl/reviews/?restaurant=$restaurantId';
}
